...
export const KLoadGraph = () => {
  ...
  const {
    ...
    queryKey: ["k-load", id, selectedMuscle?.shortname],
    queryFn: () => kLoadGraphAPI(id, selectedMuscle!.shortname),
  ...
  const layout: Partial<Layout> = {
    title: {
      text: selectedMuscle
        ? `${selectedMuscle.title} – Yuklamaga moslashish`
        : "Yuklamaga moslashish grafigi",
    ...
    yaxis: {
      title: { text: "Yuklamaga moslashish darajasi", font: { size: 14 } },
      gridcolor: isDark ? "rgba(255,255,255,0.1)" : "rgba(0,0,0,0.1)",
    },
    hovermode: "x unified",
    autosize: true,
